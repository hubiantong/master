...
const routes = {
  ...
  'bazi/analyze': async (event) => {
    ...
    const validated = validate(SingleProfileRequestSchema)(body);
  ...
  'fortune/daily': async (event) => {
    const body = parseBody(event);
    const validated = validate(DailyRequestSchema)(body);
  ...
  'marriage/analyze': async (event) => {
    const body = parseBody(event);
    const validated = validate(PairRequestSchema)(body);
  ...
  'relationship/graph': async (event) => {
    const body = parseBody(event);
    const validated = validate(GraphRequestSchema)(body);
  ...
  'meihua/daily-decision': async (event) => {
    const body = parseBody(event);
    const validated = validate(QuestionRequestSchema)(body);
  ...
  'huangli': async (event) => {
    const body = parseBody(event);
    const validated = validate(HuangliRequestSchema)(body);
